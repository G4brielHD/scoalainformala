...
def sendEmail(order_id):
    ...
    try:
        subject = "AStore - New Order #{}".format(transaction.id)
        to = ['{}'.format(transaction.emailAddress)]
        from_email = "orders@arhiphd.com"
        order_information = {
...
def contact(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            msg = EmailMessage(subject, message_format, to=['a.arhiphd@gmail.com'], from_email=from_email)
